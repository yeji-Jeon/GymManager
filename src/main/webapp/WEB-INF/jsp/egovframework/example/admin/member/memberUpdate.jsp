...
<%
  /**
  * @Class Name : memberUpdate.jsp
  * @Description : 회원 수정 화면
	...
	************************************************************/
	var defaultSet = {
		...
		memberInfoSetting : function() {
			...
			// 회원 성별 세팅
			var gender = "${memberInfo.memberInfo.mbrGender}";
			if(gender == "F") {
			...
			// 회원 사용유무 세팅
			var useYn = "${memberInfo.memberInfo.mbrUseYn}";
			if(useYn == "사용") {
				$("#cabY").prop("checked",true);
				$(".cabVisible").show();
			} else {
				$("#cabN").prop("checked",true);
			}
			
			// 회원 사물함 세팅
			$(".well").find("[name=cabId]").each(function() {
				newCabinet.cabAssignArray.push($(this).val());
			})
		}	
	}
	...
	var validation = {
		...
		validationFn : function() {
			...
			*******************************/
			...
			// 휴대폰 유효성 검사
			$("[name=phone_number]").focusout(function() {
				var $this = $(this);
			...
			if(page == "update") {
				...
				if(validation.beforeMustSubmitFn()) {
					...
					if(validation.beforeSelectSubmitFn()) {
						...
						$("#mbrAddFrm").attr("action","/admin/memberRealUpdate.do");
						$("#mbrAddFrm").submit();
					}
				}
			}
                ...
                <div class="signup-content">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            <label for="first_name">*회원ID</label>
                            <input type="text" class="form-input required" name="mbrId" value="${memberInfo.memberInfo.mbrId}" readonly/>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            onkeyup ="this.value=this.value.replace(/[^a-zA-Zㄱ-ㅎ|ㅏ-ㅣ|가-힣]/g,'');" value="${memberInfo.memberInfo.mbrNm}" maxlength="20" placeholder="'문자만 입력가능합니다/ 최대 20자" />
                    ...
                    <div class="form-row">
                    	<div class="col-md-6">
                            ...
                            <div class="col-md-8" style="padding-left: 6px;">
                           		 <input type="text" class="form-input nodisable" name="post" id="sample4_postcode" value="${memberInfo.memberInfo.mbrPostCode}"readonly/>
                            </div>
                     ...
                     <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-input nodisable" name="RoadAddress" id="sample4_roadAddress" value="${memberInfo.memberInfo.mbrRoadAddress}" readonly/>
                        </div>
                        <div class="form-group">
                            <label for="last_name">상세주소</label>
                            <input type="text" class="form-input" name="detailAddress" id="sample4_detailAddress"  value="${memberInfo.memberInfo.mbrDtlAddress}" maxlength="20" placeholder="'최대20자 입력가능"/>
                        </div>
                     </div>
	                    <div class="form-row">
	                        <div class="form-group form-icon">
	                            <label for="birth_date">*가입일</label>
	                            <input type="text" class="form-input required" name="updateJoinDate" id="startDate" value="${memberInfo.memberInfo.mbrJoindt}" readonly />
	                            <div class="must" style="color:red;">필수입력입니다.</div>
	                        </div>
	                         <div class="form-group form-icon">
	                            <label for="birth_date">*만료일</label>
	                            <input type="text" class="form-input required"  name="updateFinishDate" value="${memberInfo.memberInfo.mbrFinishdt}" id="finishDate" readonly/>
	                            <div class="must" style="color:red;">필수입력입니다.</div>
	                        </div>
	                    </div>
                        <div class="form-row">
	                        <div class="col-md-6 cellNo">
	                            ...
	                            onkeyup ="this.value=this.value.replace(/[^0-9]/g,'');" maxlength='11' value="${memberInfo.memberInfo.mbrCellno}" placeholder="'-' 없이 숫자만 입력가능합니다" />
                        ...
                        <div class="form-row">
                        	<div class="col-md-12" style="padding-bottom:10px;padding-top:15px;">
                                ...
                                <textarea class="form-input valid" name="mbrDesc" id="mbrDesc" rows="4" style="resize:none;width:100%;border:1px solid #ebebeb;" maxlength="500" aria-invalid="false"
                        ...
                        <div class="form-row">
                       		<div class="col-md-6">
	                            ...
	                            onkeyup ="this.value=this.value.replace(/[^0-9]/g,'');"maxlength='5' value="${memberInfo.memberInfo.mbrPtCnt}" placeholder="'숫자만 입력가능합니다" />
	                            <div class="must" style="color:red;">필수입력입니다.</div>
	                         </div>
                        </div>
	                           	...
	                           	<div class="form-row">
	                           		<div class="col-md-12">
	                           			<div class="col-md-3">
	                               			...
	                               			<input type="text" name="cabId" value="${cabinetInfo.cabId}"  class="cab form-control" readonly/>
	                                	</div>
	                                	<div class="col-md-4">
	                                		<label for="password">사물함 등록일</label>
	                                		<input type="text" name="cabStartDate" value="${cabinetInfo.cabRegDt}"  class="cab form-control "  readonly />
	                               		</div>
	                                	<div class="col-md-4">
	                                		<label for="password">사물함 만료일</label>
	                             			<input type="text" name="cabFinishDate" value="${cabinetInfo.cabFinishDt}"  class="cab form-control "  readonly/>
	                             		</div>
			                            <div class="input-group-append" style="padding-top:23px;">
